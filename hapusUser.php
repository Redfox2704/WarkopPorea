    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <?php $data = mysqli_query($koneksi, "SELECT * FROM kasir");?>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Hapus Data Kasir</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Hapus Data Kasir</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Tabel Hapus Data Kasir
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $isi['id_kasir'] ?></td>
                                            <td><?php echo $isi['username'] ?></td>
                                            <td><?php echo $isi['nama_kasir'] ?></td>
                                            <td class="text-center"><a class="btn btn-danger btn-sm" href="hapusU.php?id=<?php echo $isi['id_kasir']?>&username=<?php echo $isi['username']?>">Hapus Data</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
