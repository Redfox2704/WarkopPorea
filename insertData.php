<?php
      ...
      if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
        ...
        $sqlId = mysqli_query($koneksi, "SELECT max(id_pelanggan) as kodeTerbesar FROM pelanggan");
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <?php if ($query['akses'] == 'admin')header("Location: index.php"); {?>
                ...
                <main>
                    <div class="container-fluid px-4">
                      <form action="order.php" method="post">
                          <div class="mb-3">
                            <label for="kode" class="form-label">Id Pelanggan</label>
                            <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $kodePelanggan;?>" required readonly>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="form-check mb-3">
                            <input type="radio" class="form-check-input" id="jenis1" name="jenis" value="laki-laki" required>
                            <label for="jenis1" class="form-check-label">Laki-laki</label><br>
                            <input type="radio" class="form-check-input" id="jenis2" name="jenis" value="perempuan" required>
                            <label for="jenis2" class="form-check-label">perempuan</label>
                          </div>
                          <button type="submit" class="btn btn-primary" name="lanjut">Proses</button>
                        </form>
                    </div>
                </main>
