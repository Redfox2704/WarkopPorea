<?php
      ...
      if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
        ...
        $id = $_GET['id'];
        $sqlUbah = mysqli_query($koneksi, "SELECT * FROM kasir WHERE id_kasir = '$id'");
        $isi = mysqli_fetch_array($sqlUbah);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                      <form action="ubahUU.php" method="POST">
                          <div class="mb-3">
                            <label for="id" class="form-label">Id Kasir</label>
                            <input type="text" class="form-control" id="id" name="id" value="<?php echo $isi['id_kasir'];?>" required readonly>
                          </div>
                          <div class="mb-3">
                            <label for="nama" class="form-label">Nama Kasir</label>
                            <input type="text" class="form-control" id="nama" name="nama" required value="<?php echo $isi['nama_kasir'] ?>">
                          </div>
                          <div class="mb-3">
                            <label for="username" class="form-label">Username</label>
                            <input type="text" class="form-control" id="username" name="username" required value="<?php echo $isi['username'] ?>" readonly>
                          </div>
                          <div class="mb-3">
