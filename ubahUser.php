            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Ubah Data Kasir</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Ubah Data Kasir</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Tabel Ubah Data Kasir
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a class="btn btn-warning btn-sm" href="ubahU.php?id=<?php echo $isi['id_kasir'] ?>">Ubah Data</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
