<?php
      ...
      if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
        ...
        include_once('config/dashboard-cfg.php');
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="display-4"><?php echo $queryMakanan['makanan'] ?></div>

                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="order.php">Lihat Selengkapnya</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="display-4"><?php echo $queryMinuman['minuman'] ?></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Jumlah User Pelanggan</h5>
                                        <div class="display-4"><?php echo $queryPelanggan['pelanggan'] ?></div>

                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="dataPelanggan.php">Lihat Selengkapnya</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Jumlah User Kasir</h5>
                                        <div class="display-4"><?php echo $queryKasir['kasir']; ?></div>

                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="dataKasir.php">Lihat Selengkapnya</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
