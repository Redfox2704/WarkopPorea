<?php
      ...
      if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
        ...
        $sqlId = mysqli_query($koneksi, "SELECT max(id_kasir) as kodeTerbesar FROM kasir");
        $data = mysqli_fetch_array($sqlId);
        $kodeKasir = $data['kodeTerbesar'];
        $urutan = (int) substr($kodeKasir, 3, 3);
        $urutan++;
        $huruf = "KSR";
        $kodeKasir = $huruf . sprintf("%03s", $urutan);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                      <form action="tambahU.php" method="POST">
                          <div class="mb-3">
                            <label for="id" class="form-label">Id Kasir</label>
                            <input type="text" class="form-control" id="id" name="id" value="<?php echo $kodeKasir;?>" required readonly>
                          </div>
                          <div class="mb-3">
